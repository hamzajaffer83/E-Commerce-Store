            ...
            {product.type === 'variable' ? (
              selectedVariation?.sale_price ? (
                <>
                  ...
                  {selectedVariation.sale_price && <span>${selectedVariation.sale_price}</span>}
                </>
              ) : (
                selectedVariation?.price && <span>${selectedVariation?.price}</span>
              )
          ...
          {product.type === 'simple' ? (
            <>
              <Badge
                className={`bg-gray-200 ${
                  product.variations[0].quantity > 0 ? 'text-green-700' : 'text-red-600'
                }`}
              >
              ...
              <div
                className={`flex flex-row items-center gap-2 w-fit  ${
                  product.variations[0].quantity > 0 ? '' : 'pointer-events-none opacity-50'
                }`}
              >
                <QuantityButton
                  quantity={quantity}
            ...
            selectedVariation && (
              <>
                <Badge
                  className={`bg-gray-200 ${
                    selectedVariation?.quantity > 0 ? 'text-green-700' : 'text-red-600'
                  }`}
                >
                ...
                <div
                  className={`flex flex-row items-center gap-2 w-fit  ${
                    selectedVariation?.quantity > 0 ? '' : 'pointer-events-none opacity-50'
                  }`}
                >
                  <QuantityButton
                    quantity={quantity}
